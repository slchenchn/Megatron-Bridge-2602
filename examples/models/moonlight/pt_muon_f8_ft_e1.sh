...
PRETRAINED_CHECKPOINT=${SAVE_ROOT}/pretrain/Moonlight-16B-A3B_pt_f8_dist_muon_TP1/checkpoints
EXP_NAME=finetune/${MODEL_NAME}_pt_muon_f8_ft_${PRECISION_INPUT}_${OPTIMIZER_TYPE}
