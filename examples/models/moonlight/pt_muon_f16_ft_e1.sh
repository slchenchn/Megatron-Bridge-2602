...
PRETRAINED_CHECKPOINT=${SAVE_ROOT}/Moonlight-16B-A3B_pt_f16_dist_muon_TP1/checkpoints
EXP_NAME=${MODEL_NAME}_pt_muon_f16_ft_${PRECISION_INPUT}_${OPTIMIZER_TYPE}
